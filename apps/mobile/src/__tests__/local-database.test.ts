...
describe('migrateLocalDatabase', () => {
  it('creates the platform outbox and temporary active-job location queues', async () => {
    ...
    expect(sql).toContain('delivery_location_queue');
    expect(sql).toContain('active_delivery_tracking');
